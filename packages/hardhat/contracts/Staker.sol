...
contract Staker is Ownable {
    ...
    uint256 public constant startingRewardRatePerSecond = 0.001 ether;
  ...
  */
        ...
        notCompleted
    {
        ...
        uint256 stakingTimeInSeconds = block.timestamp -
            depositTimestamps[msg.sender];
        uint256 earnedInterest = (startingRewardRatePerSecond *
            (stakingTimeInSeconds * (stakingTimeInSeconds + 1))) / 2;
        uint256 indBalanceRewards = individualBalance + earnedInterest;
  ...
  */
    ...
    /*
    Retrieve back funds from external contract
  */
    function retrieveFunds()
        ...
        onlyOwner
    {
        exampleExternalContract.transferFunds();
    }
